...
\begin{tikzpicture}[x=5mm,y=5mm]
    ...
    \path (4,5.5) pic{roof=candy};
    \path (4,4)  pic{super=super};
    \path (4,2)  pic{brood=8F};
    \path (4,0)  pic{brood=8F};

    \path (8,4)  pic{super=super};
    \path (8,2)  pic{brood=8F};
    \path (8,0)  pic{brood=8F};

    \path (12,4)  pic{super=super};
    \path (12,2)  pic{brood=8F};
    \path (12,0)  pic{brood=8F};

    \path (16,4)  pic{super=super};
    \path (16,2)  pic{brood=8F};
    \path (16,0)  pic{brood=8F};

    \path (20,4)  pic{super=super};
    \path (20,2)  pic{brood=8F};
    \path (20,0)  pic{brood=8F};
    
    \path (24,4)  pic{super=super};
    \path (24,2)  pic{brood=8F};
    \path (24,0)  pic{brood=8F};
\end{tikzpicture}
