...
\begin{center}
\begin{tabular}{llcc}
{\bf Day} & {\bf Queen} & {\bf Early Beekeeper} & {\bf Late Beekeeper} \\
1 & \rdelim\}{3}{3mm}[\textsf{Egg}] & $\leftarrow$ Remove queen \\
2 \tabularnewline
...
6 &  & \\
7 &  & \\
8 & \multirow{2}{*}{\quad $\leftarrow$ Sealed} & $\leftarrow$ Cull queen cells & $\leftarrow$ Remove queen \\
\cline{1-1}
7 & \rdelim\}{8}{3mm}[\textsf{Pupa}] &  \\
8 & & \\
9 &  &  & \\
10 &  & \\
11 &  & \\
12 &  & \\
13 &  &  &  $\leftarrow$ Cull queen cells \\
14 &  & \\
15 &  & \\
...
20 &  & \\
21 &  & \\
22 & Flying & \multicolumn{2}{c}{Hope for warm weather}  \\
23 &  \\
24 &  &   \multicolumn{2}{c}{Start adding eggs from original queen} \\
\end{tabular}
