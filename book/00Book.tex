...
\begin{description}
  ...
  \item[Pins] to mark frames that have queen cells on (so you are careful with knocking them).
  \item[Cocktail Sticks]  to extract larvae for examination.
  \item[2 Hive Cover Cloths] to cover the first brood when you are looking in the second.
